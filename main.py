...
<head>
  <meta charset="utf-8">
  <title>⚔️ 𝗖𝗢𝗣𝗬 𝗞𝗔𝗥𝗡𝗘 𝗕𝗔𝗟𝗘 𝗞𝗜 𝗠𝗔 𝗞𝗜 𝗖𝗛𝗨𝗧 ⚔️</title>
  ...
  <style>
    body {
      ...
      background: linear-gradient(405deg,#ff0000,#ff7f00,#ffff00,#00ff00,#0000ff,#4b0082,#8f00ff);
      background-size: 600% 600%;
      animation: rainbowMove 18s ease infinite;
    }
    @keyframes rainbowMove {
      0% {background-position: 10% 5000%}
      50% {background-position: 1000% 500%}
      100% {background-position: 10% 500%}
    }
    .card-dark {
...
<body>
  <div class="container p-0">
    <div class="card-dark w-100">
      <h2 class="text-center">⚔️ 𝗔⃪𝗟⃪𝗢⃪𝗡⃪𝗘⃪  𝗕⃪𝗢⃪𝗜⃪𝗜⃪ 𝗔𝗝𝗘𝗘𝗧 𝗜⃪𝗡⃪𝗫⃪𝗜⃪𝗗⃪𝗘⃪ ⚔️</h2>
